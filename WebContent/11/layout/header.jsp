...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/jquery-ui-1.10.4.custom.min.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/font-awesome.min.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/bootstrap.min.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/animate.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/all.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/main.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/style-responsive.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/zabuto_calendar.min.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/pace.css">
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/styles/jquery.news-ticker.css">
				...
				<ul class="nav navbar navbar-top-links navbar-right mbn">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li class="divider"></li>
							<li><a id="logout" href="${pageContext.request.contextPath }/11/freeboard/logout.jsp"><i class="fa fa-key"></i>로그아웃</a></li>
						</ul>
					</li>
				</ul>
			</div>
...
<script type="text/javascript">
	$(function(){
		...
		$('#loginBtn').click(function(){
			...
			$(location).attr('href','${pageContext.request.contextPath}/11/freeboard/loginCheck.jsp?mem_id='+mem_id+'&mem_pass='+mem_pass)
		});
