...
$(function(){
	if(eval('${!empty param.message}')){
		...
		$('.loginBtn').click(function(){
			...
			$(location).attr('href','<%=request.getContextPath()%>/10/loginCheck.jsp?mem_id='+mem_id+'&mem_pass='+mem_pass)
		});
});
					...
					<tr>
						...
						<td>
							<table border="0" align="center" cellpadding="5"
								...
								<tr>
									<td colspan="3" align="right"><a href="<%=request.getContextPath()%>/10/main.jsp?contentPage=buyerForm.jsp">회원가입을 원하세요??</a></td>
								</tr>
							</table>
						</td>
					</tr>
